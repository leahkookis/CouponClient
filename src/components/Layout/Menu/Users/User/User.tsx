    ...
    return (
      ...
      <td>
        {editClicked ? (
          <div className="edit-buttons-container">
            <button className="save-button" onClick={openSaveEditDetailsModalIsOpen}>
      ...
      <td>
        <div className="edit-buttons-container">
          <button
            className="edit-button"
            onClick={openRemoveUserModalIsOpen}
          >
          ...
          <Modal
              ...
              >
                {/* <ConfirmationModal message={"Are you sure you want to remove this user?"} action={() => removeUser()} closeModel={() => closeRemoveUserModalIsOpen()}/> */}
              </Modal>
        </div>
      </td>
      <td>
